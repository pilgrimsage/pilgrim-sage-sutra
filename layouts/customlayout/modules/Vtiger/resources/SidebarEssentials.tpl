...
* All Rights Reserved.
************************************************************************************}
{* edited by pilgrimsage for bs5*}
<div class="sidebar-menu">
    <div class="module-filters" id="module-filters">
        <div class="sidebar-container lists-menu-container">
            <div class="sidebar-header clearfix">
                <h5 class="float-start">{vtranslate('LBL_LISTS',$MODULE)}</h5>
                <button id="createFilter" data-url="{CustomView_Record_Model::getCreateViewUrl($MODULE)}" class="btn btn-sm btn-secondary float-end sidebar-btn" title="{vtranslate('LBL_CREATE_LIST',$MODULE)}">
            ...
            <div class="menu-scroller scrollContainer" style="position:relative; top:0; left:0;">
                ...
                <div>
                    <div class="editTagContainer hide">
                        ...
                        <div>
                            <button class="btn btn-sm btn-success saveTag" type="button" style="width:50%;float:left">
                                <center> <i class="fa fa-check"></i> </center>
                            </button>
                            <button class="btn btn-sm btn-danger cancelSaveTag" type="button" style="width:50%">
